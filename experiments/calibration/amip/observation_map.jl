...
function preprocess_sim_vars(vars)
    ...
    # Convert sim diagnostics to the units of their observations (cl and clt
    # percent to fraction, pr to mm/day).
    vars = map(ClimaCoupler.CalibrationTools.standardize_sim_units, vars)

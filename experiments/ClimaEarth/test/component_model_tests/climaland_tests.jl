...
import NCDatasets, Statistics
ClimaCouplerClimaLandExt = Base.get_extension(ClimaCoupler, :ClimaCouplerClimaLandExt)
...
@testset "ClimaLandSimulation constructor" begin
    ...
    land_sim = ClimaCouplerClimaLandExt.ClimaLandSimulation(
        FT;
        dt,
        tspan,
        start_date,

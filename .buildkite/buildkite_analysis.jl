...
The main function of this module, used to generate a report comparing two builds.
...
###########
# Helper functions for parsing information from logs
###########
...
############
# Helper functions for running local tests
############

...
"""
combine_surface(mask, sfc_1, sfc_2, value = 0.5) =
    (mask > FT(value) ? sfc_1 : FT(0)) + (mask <= FT(value) ? sfc_2 : FT(0))
combine_surface(mask, sfc_1, sfc_2, sfc_3, value1 = -0.5, value2 = 0.5) =

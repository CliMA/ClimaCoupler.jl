...
cd /glade/u/home/chew/git-repos/ClimaCoupler.jl
...
JOB_ID=$(qsub experiments/calibration/gw_wq/precompute.pbs)
...
if [ -f "experiments/calibration/gw_wq/ekp_inputs.jld2" ]; then

# Cloud calibration on zonal means: lwp + cl + swcre against the warm-rain,
# snow, and cloud-fraction parameters. Companion configs lwp_cl_swcre_2d10.jl
# and lwp_cl_swcre_2d15.jl run the same problem on coarse 2-D grids, so the
# three spatial reductions can be compared directly.
#
...
output_dir = joinpath(pkgdir(ClimaCoupler), "amip_calibration_lwp_cl_swcre_zonal")

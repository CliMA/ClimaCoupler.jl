...
function Interfacer.CoupledSimulation(config_dict::AbstractDict)
    ...
    atmos_bottom_center_height = Interfacer.get_field(boundary_space, atmos_sim, Val(:height_int))
    atmos_h = Interfacer.get_atmos_height_delta(atmos_bottom_center_height, surface_elevation)

...
Usage:
    julia --project=experiments/AMIP experiments/calibration/amip/plot_ensemble_maps.jl
=#

using Pkg
Pkg.activate(joinpath(@__DIR__, "..", "..", "AMIP"))
...
const EXP_DIR = "/glade/derecho/scratch/zhaoyi/calibration/amip/exp2"

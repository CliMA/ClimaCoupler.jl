...
function slab_ice_init(
    ...
    params = IceSlabParameters(FT(2), FT(1500.0), FT(800.0), FT(280.0), FT(1e-3), FT(1e-5), FT(4e6), FT(120), FT(273.16), FT(3e8), FT(1), FT(273.16), FT(2), FT(0.38), FT(5.67e-8)) # TODO: better interface, use CLIMAParameters

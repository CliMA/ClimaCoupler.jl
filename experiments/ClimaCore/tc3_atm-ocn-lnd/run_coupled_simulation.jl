...
Plots.png(
    Plots.plot([t0_T tend_T], z_centers, labels = ["t=0" "t=end"], ylims = (0, 100)),
    joinpath(path, "T_ocn_height.png"),
)
...
Plots.png(
    ...
    joinpath(path, "enthalpy_both_surface_time_atm_lnd.png"),
)
Plots.png(
    Plots.plot(sol_lnd.t, [v3 v2 v3 + v2], labels = ["ocn" "atm" "tot"]),
    joinpath(path, "enthalpy_both_surface_time_atm_ocn.png"),
)
Plots.png(
    Plots.plot(sol_lnd.t, [v1 v3 v1 - v3], labels = ["lnd" "ocn" "diff"]),
    joinpath(path, "enthalpy_both_surface_time_ocn_lnd.png"),
)

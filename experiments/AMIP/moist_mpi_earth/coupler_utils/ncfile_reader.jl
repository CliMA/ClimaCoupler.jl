...
"""
function ncreader_rll_to_cgll(FT, datafile_rll, varname; outfile =  "data_cc.nc", ne = 4, R = 5.0, Nq = 5)
...
function LandSeaMask(FT, infile, varname; outfile =  "data_cc.nc", ne = 4, R = 6371e3, Nq = 5)
    mask = ncreader_rll_to_cgll(FT, "data/seamask.nc",  "LSMASK", ne = ne, R = R, Nq = Nq)    

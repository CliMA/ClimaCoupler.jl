...
"""
    get_land_fraction(land_fraction_source, boundary_space, comms_ctx; binary_area_fraction = true)

Read and remap the land-sea fraction field onto the coupler boundary grid.

# Arguments
- `land_fraction_source`: Source of land fraction data. Either "etopo" or "era5".
...
function get_land_fraction(
    ...
    # Ensure land fraction is finite and clamp to [0, 1]

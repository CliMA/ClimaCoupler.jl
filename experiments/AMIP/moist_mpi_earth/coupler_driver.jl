...
if prescribed_sst
    ...
    weightfile, datafile_cgll, regrid_space = ncreader_rll_to_cgll_from_space(sst_data, "SST", boundary_space, outfile = "sst_cgll.nc")
...
weightfile, datafile_cgll, regrid_space = ncreader_rll_to_cgll_from_space(sic_data, "SEAICE", boundary_space, outfile = "sic_cgll.nc")

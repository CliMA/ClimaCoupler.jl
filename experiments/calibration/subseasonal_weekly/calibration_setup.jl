...
const CALIBRATION_PRIORS = [
    ...
    PD.constrained_gaussian("diagnostic_covariance_coeff", 2.1, 1, 0.0, 10.0),
    PD.constrained_gaussian("Tq_correlation_coefficient", 0.0, 0.5, -1.0, 1.0),

    
    PD.constrained_gaussian("mixing_length_eddy_viscosity_coefficient", 0.2, 0.1, 0, 3.0),
    PD.constrained_gaussian("mixing_length_diss_coeff", 0.3, 0.1, 0.0, 10.0),
    PD.constrained_gaussian("mixing_length_tke_surf_flux_coeff", 5.0, 2.0, 0, 20.0),

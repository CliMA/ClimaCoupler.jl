...
"""
    update_tspan!(config_dict, start_date, end_date)

Update `start_date` and `end_date` in `config_dict`.
"""
function update_tspan!(config_dict, start_date::Dates.DateTime, end_date::Dates.DateTime)

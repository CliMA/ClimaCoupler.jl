...
export RESTART_DIR=output/${JOB_ID}/checkpoints/
...
srun -K julia --project=experiments/AMIP/ experiments/AMIP/run_simulation.jl --config_file $CONFIG_FILE --job_id $JOB_ID
...
# rerun the model
srun -K julia --project=experiments/AMIP/ experiments/AMIP/run_simulation.jl --config_file $RESTART_CONFIG_FILE --job_id $JOB_ID --restart_dir $RESTART_DIR --restart_t $RESTART_T

...
@testset "ClimaLandSimulation flux calculations" begin
    ...
    # Initialize land cache after drivers are exchanged. This sets `p.snow.T_sfc`
    # (used as the SurfaceFluxes ≥1.2 initial guess for the snow skin-temperature
    # Newton update) and updates aux / boundary-flux cache variables.

...
julia --project=experiments/ClimaEarth experiments/calibration/gw_wq/generate_observations.jl

# 2. Run calibration (from tmux on login node)
julia --project=experiments/ClimaEarth experiments/calibration/gw_wq/run_calibration.jl
```
...
./experiments/calibration/gw_wq/run_full_calibration.sh
```
...
Plot results:
```bash
julia --project=experiments/ClimaEarth experiments/calibration/gw_wq/quick_plot_cal.jl
```

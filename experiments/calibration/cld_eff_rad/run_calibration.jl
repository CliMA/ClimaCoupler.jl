...
include("experiments/calibration/cld_eff_rad/plot_from_EKP.jl")
...
priors = [
    constrained_gaussian("ice_cloud_effective_radius", 25e-6, 1e-5, 5e-6, 9e-5), # r_eff_ice
...
# observation_path = joinpath(experiment_dir, "sep+3months.jld2")
observation_path = joinpath(experiment_dir, "sep+3months_exotropics.jld2")

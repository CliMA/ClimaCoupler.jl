...
function preprocess_var(var, sample_date_range)
    ...
    var = ClimaAnalysis.Var.transform_dates(var, date -> date - period)
...
function plot_toa_flux_bias(simdir, iteration; output_dir = simdir.simulation_path)
    era5_toa_rad_fluxes_path =
        joinpath(pkgdir(ClimaCoupler), "era5_oct_2018_2024_toa_rad_fluxes.nc")

...
- [docs/clima_coupler_specific.md](docs/clima_coupler_specific.md) — directory layout, key abstractions, test groups, and conventions specific to ClimaCoupler.jl.

...
function calculate_sfc_fluxes_energy(formulation::DryMonin, parameters, T_sfc, T_1, u_1, v_1, ρ_1, t ) 
    ...
    domain_atm  = Domains.IntervalDomain(0, atmos_Lz, x3boundary = (:bottom, :top)) # struct
    mesh_atm = Meshes.IntervalMesh(domain_atm, nelems = atmos_Nz) # struct, allocates face boundaries to 5,6

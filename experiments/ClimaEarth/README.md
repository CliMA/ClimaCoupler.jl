...
Designed to generate 3-4 week forecasts from ERA5-derived initial conditions. Similar to `amip` setup. Provide a single directory and filenames will be inferred from `start_date`. Initial condition files are generated by `https://github.com/CliMA/WeatherQuest`.

...
function OceananigansSimulation(
    ...
    FT_ocean = Float64
    OC.defaults.FloatType = FT_ocean
...
remapper needed to remap between the two grids in both directions.
...
and update the ice concentration field in the ocean simulation
